        ...
        <div className="mx-1 w-full">
            {!isSearch && (
                <div className="flex justify-end">
                    <p onClick={isSearchChangeHandler} className="flex justify-center  items-center w-10 h-10 m-0 rounded-full bg-[#023e8a] text-white shadow-lg cursor-pointer">
                ...
                <div className="flex justify-end w-full items-center">
                    <div className="mx-1 w-110 ">
                        <motion.div initial={{ opacity: 0, translateX: 20 }} animate={{ opacity: 1, translateX: 0 }} exit={{ opacity: 0, translateX: 20 }} transition={{ duration: 0.6, ease: "easeOut" }}>
                            <Input.Search value={searchStr} onBlur={onBlurHandler} onFocus={onFocusedHandler} onChange={onChangeHandler} placeholder="Type the product you're looking for…" />
                    ...
                    <div className="mx-2">
                        <p onClick={isSearchChangeHandler} className="flex justify-center items-center w-10 h-10 m-0 rounded-full bg-[#9d0208] text-white shadow-lg cursor-pointer">
